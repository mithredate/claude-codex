...
Help the user create, review, or improve their CLAUDE.md file.

**Load the manage-claude-md skill first** using the Skill tool, then follow its workflow exactly.
