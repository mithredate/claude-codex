...
If the host project is not JavaScript and the audience is developers, build the same layout as a terminal app in the project language instead, so the validated logic module lifts straight into the real codebase.
