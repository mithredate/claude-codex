...
- **Decisions are options with a recommendation.** 2–3 viable options with pros/cons, recommend one with reasoning, one question at a time. Mehrdad owns architecture: never silently pick a structural choice. When a decision needs shared understanding, grill him (`productivity:grilling`).
